...
?>
							...
							echo "</tr>";
								...
								<table width="100%" class="table table-striped table-bordered table-hover">
								<tr><td style="text-align:center;vertical-align: middle;" rowspan='3' width="20%"><b>Kriteria</b></td><td colspan='8' style="text-align:center"><b>Penilai</b></td></tr>
								<tr>
								<?php
								$sqla = "SELECT * FROM `master_penilai`";
								$resulta = mysqli_query($conn, $sqla);
								...
								if (mysqli_num_rows($resulta) > 0) {
									...
									echo substr($_SESSION['nilaikahir'][$a]['total'],0,12);
									echo "</b></td>";
									}
								}
								echo "</tr>";
								echo "<tr><form action=\"\" method=\"POST\">";
									...
									echo "</td>";
										echo "<td colspan ='2' style=\"text-align:right\"><b>";
								...
								<tr>
									<td colspan='9'><b>Rating Akhir - <span style="color:<?php echo $color;?>"><?php echo $ketrat;?></span></b></td>
								</tr>
								</form></table>
