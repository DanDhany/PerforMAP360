...
<head>
  ...
  <title>PerforMAP360 | Perhitungan Penilaian</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Perhitungan Penilaian</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
?>
								...
								$sql1 = "SELECT periode from transaksi_penilaian a where status='' or status='1' group by a.periode";
								$result1 = mysqli_query($conn, $sql1);
								if (mysqli_num_rows($result1) > 0) {
									while($row = mysqli_fetch_assoc($result1)) {
									$period = $row["periode"];
