...
?>
                              ...
                              <table width="100%">
										<tr><td colspan='6' style="text-align:center"><h3>Form Pengukuran Kinerja Karyawan</td></tr>
										...
										<tr><td><b>Jabatan</td><td>:</td><td><?php echo $d1; ?></td><td><b>Periode Penilaian</td><td>:</td><td><?php echo $periode; ?></td></tr>
							  </table><br> 
							<table width="100%" class="table table-striped table-bordered table-hover" id="bagianlist">		
                                <thead>
                                    <tr>
                                        <th style="text-align:center">Kriteria</th>
                                        <th style="text-align:center">Sub Kriteria (Pertanyaan)</th>
								...
								$sql1 = "SELECT kdkri, (SELECT a.namkri from master_kriteria a where a.kdkri=b.kdkri) as namakri, kdsub ,`ketsub` FROM `master_subkriteria` b WHERE kdkri in (SELECT kdkri from master_bobot WHERE kdpenilai='$penilai' and bobot!='0') and status='1' order by kdkri asc";
