							...
							echo "</td>";
								...
								if (mysqli_num_rows($result1) > 0) {
									...
									echo "<td colspan='2'><b>Sub Total Nilai</b></td>";
										...
										echo $_SESSION['data'][$x]['total'] = array_sum($totalkri); echo "\">";
										...
										echo $_SESSION['data'][$x]['penilaiE'] = $b; echo "\">";
										$penilaiPie= $_SESSION['data'][$x]['penilaiE'];
...
?>
								...
								$sql1 = "SELECT a.nik, (select Nama_Lengkap from master_karyawan b where b.nik=a.nik group by nik) as nama, periode from transaksi_penilaian a where a.periode='$periode' group by a.nik";
								$result1 = mysqli_query($conn, $sql1);
								if (mysqli_num_rows($result1) > 0) {
									while($row = mysqli_fetch_assoc($result1)) {
										echo "<tr><form action=\"\" method=\"POST\">"; 
