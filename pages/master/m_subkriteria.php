...
<head>
  ...
  <title>PerforMAP360 | Master Sub Kriteria</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Master Sub Kriteria</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
              <li class="breadcrumb-item active">Master Sub Kriteria</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Sub Kriteria</h3>
...
if(isset($_POST['updatestat'])){
	if($_POST['datstatus'] == '1'){
		$a = $_POST['datkdsub'];
		$b = $_POST['datkriteria'];
		$sql1 = "update master_subkriteria set status='0' where kdsub='$a' and kdkri='$b'";
		mysqli_query($conn, $sql1);
		$sqlc = "select count(*)as cek from master_subkriteria";
		...
		$a = $_POST['datkdsub'];
		$b = $_POST['datkriteria'];
		$sql1 = "update master_subkriteria set status='1' where kdsub='$a' and kdkri='$b'";
		mysqli_query($conn, $sql1);
		$sqlc = "select count(*)as cek from master_subkriteria";
		$result1= mysqli_query($conn, $sqlc);
		$row = mysqli_fetch_assoc($result1);	
...
$a = $_POST['kriteria']; 
$b = $_POST['kdsub']; 
$c = ucwords(strtolower($_POST['namsub']));
$d = $_POST['ketsub'];
$e = $_POST['status'];
$sqlb = "select count(*) as cek from master_subkriteria where kdsub='$b' and kdkri='$a'";
$result= mysqli_query($conn, $sqlb);
$row = mysqli_fetch_assoc($result);

if ($row['cek'] == '0'){
	
	$sql = "INSERT INTO master_subkriteria
	VALUES ('$a', '$b', '$c', '$d', '$e' )";
...
$sql1 = "Delete from master_subkriteria where kdkri='$a' and kdsub='$b'";
mysqli_query($conn, $sql1);
$sqlc = "select count(*)as cek from master_subkriteria";
$result1= mysqli_query($conn, $sqlc);
$row = mysqli_fetch_assoc($result1);	
...
$sql2 = "update master_subkriteria
set namsub='$c', ketsub='$d', status='$e' where kdsub='$b' and kdkri='$a'";
...
?>	
									<form role="form" action="" method="POST">
										...
										<label>Kriteria</label>
											<input class="form-control" name="kriteria" value="<?php echo $a1; ?>" readonly>
										</div>
										<div class="form-group">
                                            <label>Kode Sub Kriteria</label>
                                            <input class="form-control" name="kdsub" value="<?php echo $b1; ?>" readonly>
                                        </div>
										<div class="form-group">
                                            <label>Nama Sub Kriteria</label>
                                            <input class="form-control" name="namsub" value="<?php echo $c1; ?>" required>
                                        </div>
										<div class="form-group">
                                            <label>Pertanyaan Kuisioner(Keterangan Sub Kriteria)</label>
                                            <input class="form-control" name="ketsub" value="<?php echo $d1; ?>" required>
                                        </div>
										<div class="form-group">
                                            <label>Status</label>
...
?>
                                    <form role="form" action="" method="POST">
										...
										<div class="form-group">
                                            <label>Kode Sub Kriteria</label>
                                            <input class="form-control" name="kdsub" placeholder="Masukkan Kode Kriteria" required>
                                        </div>
										<div class="form-group">
                                            <label>Nama Sub Kriteria</label>
                                            <input class="form-control" name="namsub" placeholder="Masukkan Nama Kriteria" required>
                                        </div>
										<div class="form-group">
                                            <label>Pertanyaan Kuisioner(Keterangan Sub Kriteria)</label>
                                            <input class="form-control" name="ketsub" placeholder="Masukkan Keterangan Kriteria" required>
                                        </div>
										<div class="form-group">
                                            <label>Status</label>
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="bagianlist">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:center">Pertanyaan (Keterangan)</th>
								...
								$sql1 = "SELECT * from master_subkriteria";
								...
								if (mysqli_num_rows($result1) > 0) {
									while($row = mysqli_fetch_assoc($result1)) {
										...
										echo $row["kdsub"];echo "\">";echo $row["kdsub"];
										echo "</td>";
										echo "<td> <input type=\"hidden\" class=\"form-control\" name=\"datnamsub\" value=\"";
										echo $row["namsub"];echo "\">";echo $row["namsub"];
										echo "</td>";
										echo "<td> <input type=\"hidden\" class=\"form-control\" name=\"datketsub\" value=\"";
